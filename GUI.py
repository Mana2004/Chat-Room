...
class ChatApp(Client):
    def __init__(self, root, host, port):
        ...
        self.chat_frame = tk.Text(self.root, state='disabled', height=20, width=60, wrap='word', bg="#1e1e1e", fg="white",
        ...
        tk.Button(self.button_frame, text="Exit", command=self.exit_chat, bg="#ff4d4d", fg="white",
